...
import type { AlbumDialogProps } from './album-dialog.interface';
import styles from './album-dialog.module.scss';
...
export const AlbumDialog: FC<AlbumDialogProps> = ({ isOpen, onOpenChange }) => {
  return (
    <Dialog isOpen={isOpen} onOpenChange={onOpenChange}>
      <div className={styles.root}>
        <div className={styles.info}>
          ...
          <Typography variant='body1'>32 photos</Typography>
        </div>
        <div className={styles.gallery}>
          <Gallery images={imagesData} rowImagesCount={6} />
        </div>
      </div>
    </Dialog>
  );
